...
export async function POST(req: Request) {
  ...
  const { connectorId, name, keywords, minPrice, maxPrice, minShopAgeMonths, maxShopAgeMonths, minReviewCount } = body;
  ...
  // Ownership check — the connector must belong to this org.
