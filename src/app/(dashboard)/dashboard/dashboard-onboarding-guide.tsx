    ...
    <div className="rounded-2xl border border-[#2A362D] bg-[#141B16] text-white p-6 shadow-md relative overflow-hidden space-y-6">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 pb-5 border-b border-[#2A362D] relative z-10">
        ...
        <button
          ...
          className="text-xs font-semibold text-[#9EAA9F] hover:text-white flex items-center gap-1 self-start md:self-center px-2.5 py-1.5 rounded-lg bg-[#1C261F] border border-[#2A362D] transition-colors"
            ...
            >
              <div className="space-y-2.5">
                ...
                <div>
                  ...
                  <p className="text-[11px] text-[#9EAA9F] mt-1 leading-relaxed">
                    {step.description}
                  </p>
                </div>
              </div>

              <div className="pt-4 mt-2 border-t border-[#2A362D]/60">
                <Link href={step.href}>
                  <Button
                    variant="primary"
                    size="compact"
                    className="w-full text-xs font-semibold bg-[#0E8F5D] hover:bg-[#0C7A52] text-white shadow-xs flex items-center justify-center gap-1.5"
                  >
                    <span>{step.cta}</span>
