    ...
    <Card className="p-5 border rounded-2xl bg-card hover:border-primary/40 transition-all space-y-4 shadow-sm flex flex-col justify-between">
      <div className="space-y-3">
        <div className="flex items-center justify-between gap-2">
          ...
          <div className="flex items-center gap-1.5">
            <span className="text-label-sm text-muted-foreground font-semibold">Idea Score:</span>
            <Badge variant="neutral" className="text-label-sm font-black text-primary">
              {idea.ideaScore}/100
            </Badge>
          </div>
        </div>
        ...
        <p className="text-sm text-muted-foreground leading-relaxed">{idea.whyThisIdea}</p>
        ...
        <div className="space-y-2 pt-2 border-t text-sm">
          ...
          <div className="space-y-1">
            <span className="text-label-sm font-bold uppercase text-sky-600 dark:text-sky-400 block">
      ...
      <div className="flex items-center gap-2 pt-3 border-t">
        <Button onClick={handleValidate} size="compact" variant="primary" className="text-sm flex-1">
          <Compass className="w-3.5 h-3.5 mr-1" />
          Validate
        </Button>
        <Button onClick={handleResearch} size="compact" variant="secondary" className="text-sm flex-1">
