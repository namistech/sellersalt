  ...
  theme: {
    extend: {
      ...
      fontSize: {
        ...
        h2: ["19px", { lineHeight: "1.3", letterSpacing: "-0.005em", fontWeight: "600" }],
        h3: ["16px", { lineHeight: "1.35", fontWeight: "600" }],
        h4: ["14.5px", { lineHeight: "1.4", fontWeight: "600" }],
        "body-lg": ["15px", { lineHeight: "1.5" }],
        "body-md": ["13.5px", { lineHeight: "1.5" }],
        "body-sm": ["12.5px", { lineHeight: "1.45" }],
        "label-md": ["12px", { lineHeight: "1.3", letterSpacing: "0.01em", fontWeight: "500" }],
        "label-sm": ["11px", { lineHeight: "1.3", letterSpacing: "0.02em", fontWeight: "500" }],
        ...
        "data-md": ["14px", { lineHeight: "1.3", fontWeight: "500" }],
        "data-sm": ["12px", { lineHeight: "1.3", fontWeight: "500" }],
      },
      borderRadius: {
        xs: "4px",
        sm: "6px",
