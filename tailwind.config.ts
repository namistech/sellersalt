...
const config: Config = {
  ...
  theme: {
    extend: {
      ...
      fontSize: {
        "display-2xl": ["64px", { lineHeight: "1.05", letterSpacing: "-0.02em", fontWeight: "600" }],
        "display-xl": ["56px", { lineHeight: "1.08", letterSpacing: "-0.02em", fontWeight: "600" }],
        "display-lg": ["48px", { lineHeight: "1.1", letterSpacing: "-0.015em", fontWeight: "600" }],
        "display-md": ["40px", { lineHeight: "1.12", letterSpacing: "-0.015em", fontWeight: "600" }],
