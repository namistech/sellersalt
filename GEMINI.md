# GEMINI.md — SellerSalt Agent Guidelines

Welcome to the SellerSalt repository. All AI coding agents operating in this codebase must strictly observe the guidelines below.
